...
namespace HoangCN.MainSystem.Utils
{
    ...
    public static class EnvKeys
    {
        ...
        public const string CONNNECTION_STRING_MYSQL_MAIN_SYSTEM = "CONNNECTION_STRING_MYSQL_MAIN_SYSTEM";
        public const string CONNNECTION_STRING_REDIS = "CONNNECTION_STRING_REDIS";
    }
}
